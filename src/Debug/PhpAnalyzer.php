...
//          }
     ...
     * @return array
     */
    public function getInfo($definition)
    {
     ...
     * @return array
     */
    public function getInfoWithReflection($definition)
    {
     ...
     * @return string
     */
    private function prefixNamespace($namespace, $identifier, $uses = [])
    {
