...
class Autoloader extends Object {
    ...
    private $defaultSettings = array(
        ...
        'ignore_folders' => [], // Exclude these folders (relative from autoloader.ini) otherwise use absolute paths
     ...
     * @return void
     */
    function importFolder($path, $settings = []) {
     ...
     */
    function importFile($filename, $settings = []) {
