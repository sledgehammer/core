...
//		CURLOPT_TIMEOUT => ?, // Don't allow the request to take more time the the internal php timeout.
     ...
     */
    static function get($url, $options = [], $callback = null) {
     ...
     * @return \Sledgehammer\Curl  Response
     */
    static function post($url, $data = [], $options = [], $callback = null) {
     ...
     * @return \Sledgehammer\Curl  Response
     */
    static function put($url, $data = '', $options = [], $callback = null) {
        $defaults = self::defaults(array(
                    CURLOPT_URL => $url,
     ...
     * @return Curl
     */
    static function putFile($url, $filename, $options = [], $callback = null) {
        $fp = fopen($filename, 'r');
        $defaults = self::defaults(array(
                    CURLOPT_URL => $url,
                    CURLOPT_PUT => true,
     ...
     * @return \Sledgehammer\Curl  Response
     */
    static function delete($url, $options = [], $callback = null) {
        $options[CURLOPT_URL] = $url;
        $defaults = self::defaults(array(
     ...
     * @return Curl
     */
    static function download($url, $filename, $options = [], $async = false) {
        $fp = fopen($filename, 'w');
        if ($fp === false) {
